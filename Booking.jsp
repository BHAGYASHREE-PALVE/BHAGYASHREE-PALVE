			...
			<div class="collapse navbar-collapse" id="navbarText">
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					<li class="nav-item"><a class="nav-link active"
						aria-current="page" href="index.jsp" target="_blank">Home</a></li>
...
%>
	...
	<form action="LoginServlet">
		<input type="checkbox" name="Checkbox">please verify details
		and click check box. <br> <input type="hidden" name="modalForm"
			value="BookingPayment" /> <input type="submit" value="Payment">
	</form>
